...
| ---------------- | ------------------------------------------------------------- | ------------------------------------------ |
| Pydantic V2      | `@.agents/references/fastapi-expert/pydantic-v2.md`           | Creating schemas, validation, model_config |
| SQLAlchemy       | `@.agents/references/fastapi-expert/async-sqlalchemy.md`      | Async database, models, CRUD operations    |
| Endpoints        | `@.agents/references/fastapi-expert/endpoints-routing.md`     | APIRouter, dependencies, routing           |
| Authentication   | `@.agents/references/fastapi-expert/authentication.md`        | JWT, OAuth2, get_current_user              |
| Testing          | `@.agents/references/fastapi-expert/testing-async.md`         | pytest-asyncio, httpx, fixtures            |
| Django Migration | `@.agents/references/fastapi-expert/migration-from-django.md` | Migrating from Django/DRF to FastAPI       |
